...
public class RecurringTaskTest {
    ...
    public void setUp() throws Exception {
        ...
        RecurringTask task = new RecurringTask("name", LocalDate.now(), LocalDate.now(), "week",1);
        RecurringTask taskk = new RecurringTask("name1", LocalDate.now(), LocalDate.now(), "day",1);
        list.add(task);
        list.add(taskk);
    }
    ...
    public void test() {
        ...
        RecurringTask taskkkk = new RecurringTask("name2", LocalDate.of(2016, 03, 13),
                LocalDate.of(2016, 03, 15), "week",1);
        taskkkk.adjustDate();
        ...
        RecurringTask taskkkkkkk = new RecurringTask("name2", LocalDate.of(2016, 03, 23),
                LocalDate.of(2016, 03, 24), "week",1);
        ...
        RecurringTask taskkkkkkkk = new RecurringTask("name2", LocalDate.of(2016, 03, 25),
                LocalDate.of(2016, 03, 25), "week",1);
