...
public class UserInputParser implements ParserInterface {
	...
	private static final int NUMBER_ONLY_START = 5;
	private static final int NUMBER_ONLY_END = 6;
	...
	protected void isEnglishDate() {
		...
		} else if (parser.isDate(userCommand[lengthOfInput - 2]) && isStart(userCommand[lengthOfInput - 2])) {
			numToUse = NUMBER_ONLY_START;
		} else if (parser.isDate(userCommand[lengthOfInput - 2]) && isEnd(userCommand[lengthOfInput - 2])) {
