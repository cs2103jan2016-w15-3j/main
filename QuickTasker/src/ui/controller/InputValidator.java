...
public class InputValidator extends UserInputParser {
    ...
    private boolean checkUndoRedo(String input) {
        ...
        return cmd == Commands.UNDO_TASK || cmd == Commands.REDO_TASK;
    }
    ...
    private boolean checkTime(String input) {
        ...
        return !isTimeAvailable() || (isEqualDate(input) && endTime.isAfter(startTime));
    }
    ...
    private boolean checkDate(String input) {
        ...
        return !isDateAvailable() || endDate.isAfter(startDate) || endDate.isEqual(startDate);
    }
