...
public class RecurringTaskTest {
    ...
    @Before public void setUp() throws Exception {
        ...
        RecurringTask task = new RecurringTask("name", LocalDate.now(), LocalDate.now(), "week", LocalTime.now(), LocalTime.now(), 1);
        RecurringTask taskk = new RecurringTask("name", LocalDate.now(), LocalDate.now(), "week", LocalTime.now(), LocalTime.now(), 1);
        list.add(task);
        list.add(taskk);
    }
