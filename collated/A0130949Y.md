# A0130949Y
###### QuickTasker\src\logic\AddTask.java
``` java
...
```
###### QuickTasker\src\logic\ClearTasks.java
``` java
...
```
###### QuickTasker\src\logic\Command.java
``` java
...
```
###### QuickTasker\src\logic\DeleteTask.java
``` java
...
```
###### QuickTasker\src\logic\Logic.java
``` java
...
```
###### QuickTasker\src\logic\MarkTask.java
``` java
...
```
###### QuickTasker\src\logic\SkipRecurTask.java
``` java
...
```
###### QuickTasker\src\logic\StopRecurTask.java
``` java
...
```
###### QuickTasker\src\logic\UpdateTask.java
``` java
...
```
###### QuickTasker\src\model\RecurringTask.java
``` java
...
```
###### QuickTasker\src\parser\DaysInWeek.java
``` java
...
```
###### QuickTasker\tests\logic\AddTaskTest.java
``` java
...
```
###### QuickTasker\tests\logic\DeleteTaskTest.java
``` java
...
```
###### QuickTasker\tests\logic\SkipRecurTaskTest.java
``` java
import model.RecurringTask;
...
```
###### QuickTasker\tests\logic\UpdateTaskTest.java
``` java
...
```
###### QuickTasker\tests\model\RecurringTaskTest.java
``` java
import org.junit.Before;
import org.junit.Test;
